...
},
{
  ...
  "number": "2.2.24",
  "title": "",
  "body": "  Let A_\\alpha be a subspace of a space X_\\alpha for all \\alpha. Let \\cT_{\\text{prod}} be the product topology on \\prod_\\alpha A_\\alpha. Let \\cT sub be the subspace topology on \\prod_\\alpha A_\\alpha induced by the product topology on \\prod_\\alpha X_\\alpha. Then \\cT_{\\text{prod}} = \\cT sub.   "
},
{
  "id": "def-2.90",
  "level": "2",
  ...
  "number": "2.2.25",
  "title": "",
  "body": "  Let X be a topological space and let \\sim be an equivalence relation on X. Let X\/\\sim be the set of equivalence classes and let q: X \\to X\/\\sim be the equivalence map (defined by q(p) := [p] for all p in X). The quotient topology, or identification topology on X\/\\sim induced by \\sim, is the topology \\cT \\sim = \\cT quo:= \\{U \\sse X\/\\sim | q -1(U) is open in X\\}. The set X\/\\sim together with the quotient topology is called a quotient space of X, and the equivalence map q is called the quotient map induced by \\sim.   "
},
{
  "id": "prop-2.92",
  "level": "2",
...
},
{
  ...
  "number": "2.2.27",
  "title": "",
  "body": "  (CC12-i) If X\/\\sim is a quotient space of X and q: X \\to X\/\\sim is the equivalence map (defined by q(p) := [p] for all p in X), then q is a continuous surjection. (b) The quotient topology induced by an equivalence relation is the largest topology on the set of equivalence classes for which the equivalence map is continuous.   "
},
{
  "id": "def-2.95",
  "level": "2",
  ...
  "number": "2.2.28",
  "title": "",
  "body": "  Let (X,\\cT X) be a topological space, let Y be a set, and let f:X \\to Y be a surjective function. The quotient topology on Y induced by f is \\cT q := \\{V \\sse Y | f\\inv(V) \\in \\cT X\\}. If Y has the quotient topology induced by f then f is called a quotient map.   "
},
{
  "id": "prop-2.97",
  "level": "2",
...
},
{
  ...
  "number": "2.2.31",
  "title": "",
  "body": "  Let X be a topological space. (a) If \\sim is an equivalence relation on X, then the quotient topology on X\/\\sim induced by \\sim equals the quotient topology on X\/\\sim induced by the equivalence map q:X \\to X\/\\sim (defined by q(p) := [p] for all p in X). (b) If f:X \\to Y is a surjection, then the quotient space (Y,\\cT f) is homeomorphic to the quotient space (X\/\\sim,\\cT \\sim ) induced by the equivalence relation on X defined by x \\sim x' if and only if f(x) = f(x') for all x,x' \\in X; moreover, the homeomorphism g:X\/\\sim \\to Y satisfies g \\circ q = f, where q is the equivalence map.   "
},
{
  "id": "example-13",
  "level": "2",
...
},
{
  ...
  "number": "2.2.33",
  "title": "",
  "body": "  Let X = [0,1] have the Euclidean subspace topology, and let \\sim be the equivalence relation on X defined by p \\sim q if and only if either [p=q] or [\\{p,q\\} = \\{0,1\\}]. Then the quotient space X\/\\sim is isomorphic to S1.   "
},
{
  "id": "def-2.106",
  "level": "2",
  ...
  "number": "2.2.34",
  "title": "",
  "body": "  Let X = [0,1] \\times [0,1] have the product topology (where each [0,1] has the Euclidean subspace topology).   The torus T2 is the quotient space X\/\\sim where \\sim is the equivalence relation on X generated by (r,0) \\sim (r,1) and (0,s) \\sim (1,s) for all r,s \\in [0,1].      The Klein bottle K2 is the quotient space X\/\\sim where \\sim is the equivalence relation on X generated by (r,0) \\sim (r,1) and (0,s) \\sim (1,1-s) for all r,s \\in [0,1].      The Mobius band M2 is the quotient space X\/\\sim where \\sim is the equivalence relation on X generated by (0,s) \\sim (1,1-s) for all s \\in [0,1].      "
},
{
  "id": "def-2.108",
  "level": "2",
  ...
  "number": "2.2.35",
  "title": "",
  "body": "  The projective plane P2 is the quotient space P2 := S2\/\\sim where S2 := \\{(x,y,z) \\in \\R 3 | x2 + y2 + z2 = 1\\} is the 2-sphere (with the Euclidean subspace topology) and \\sim is the equivalence relation generated by (x,y,z) \\sim (-x,-y,-z) for all (x,y,z) \\in S2.   "
},
{
  "id": "thm-2.110",
  "level": "2",
  ...
  "number": "2.2.36",
  "title": "",
  "body": "  Let X = [0,1] \\times [0,1] have the product topology (where each [0,1] has the Euclidean subspace topology).   The cylinder S1 \\times [0,1] is homeomorphic to the quotient space X\/\\sim where \\sim is the equivalence relation on X generated by (r,0) \\sim (1,r) for all r \\in [0,1].    The projective plane P2 is homeomorphic to the quotient space X\/\\sim where \\sim is the equivalence relation on X generated by (r,0) \\sim (1-r,1) and (0,1-s) \\sim (1,s) for all r,s \\in [0,1].    The 2-sphere S2 is homeomorphic to the quotient space X\/\\sim where \\sim is the equivalence relation on X generated by (r,0) \\sim (0,r) and (s,1) \\sim (1,s) for all r,s \\in [0,1].    The torus T2 is homeomorphic to the product space S1 \\times S1 where each S1 has the Euclidean subspace topology.      "
},
{
  "id": "thm-2.120",
  "level": "2",
...
},
{
  ...
  "number": "2.2.44",
  "title": "",
  "body": "  Let (X,\\cT X) and (Y,\\cT_Y) be topological spaces with X \\cap Y = \\es. The disjoint union topology on X \\cup Y is \\cT ∐ = \\{ U \\cup V | U \\in \\cT X and V \\in \\cT_Y \\}.   "
},
{
  "id": "def-2.136",
  "level": "2",
...
},
{
  ...
  "number": "3.1.3",
  "title": "",
  "body": "  A space (X,\\cT X) is a finite topological space if the set X is finite.   "
},
{
  "id": "def-3.7",
  "level": "2",
...
},
{
  ...
  "number": "3.2.6",
  "title": "",
  "body": "  A topological space (X,\\cT X) is metrizable if there is a metric d on X such that \\cT X = \\cT d (where \\cT d is the metric topology on X induced by d).   "
},
{
  "id": "thm-3.28",
  "level": "2",
...
},
{
  ...
  "number": "3.4.5",
  "title": "",
  "body": "  Let A be a subspace of a topological space (X,\\cT X). The space A is compact if and only if for every collection \\cC of open sets in X satisfying A \\sse \\cup C \\in \\cC C, there is a finite subcollection 𝒟 \\sse \\cC such that A \\sse \\cup D \\in 𝒟 D.   "
},
{
  "id": "thm-3.132",
  "level": "2",
...
},
{
  ...
  "number": "3.5.1",
  "title": "",
  "body": "  A space (X,\\cT X) has a countable basis if the topology \\cT X is generated by a basis that is a countable set.   "
},
{
  "id": "thm-3.171",
  "level": "2",
...
},
{
  ...
  "number": "3.5.5",
  "title": "",
  "body": "     If (X,\\cT X) is a compact and metrizable space, then \\cT X is generated by a countable basis.    Metrizability does not imply a countable basis.      "
},
{
  "id": "def-3.180",
  "level": "2",
...
},
{
  ...
  "number": "5.1.9",
  "title": "",
  "body": "  \\pi_1(X,x0) = 1 for all x0 in X iff every continuous map S1 \\to X extends to a continuous map D2 \\to X.   "
},
{
  "id": "sec-group-homs",
  "level": "1",
...
},
{
  ...
  "number": "5.3",
  "title": "\\pi_1(S1)",
  "body": "\\pi_1(S1)    For each integer n, let ωn be the loop in S1 defined by ωn(s) := ( cos(2 \\pi n s), sin(2 \\pi n s) ) for all s \\in I. Then [ωm][ωn] = [ωm+n] in \\pi_1(S1,(1,0)).    Path and Path Homotopy Lifting Theorems (PPHLT) for S1   Let p: R \\to S1 be defined by p(t) := (cos(2\\pi t), sin(2\\pi t)) for all t \\in R.   (PLT) Given a path f: (I,0) \\to (S1,(1,0)), there is a unique path f\": (I,0) \\to (R,0) such that p \\circ f\" = f.    (PHLT) Given a path homotopy H: (I \\times I,(0,0)) \\to (S1,(1,0)) there is a unique path homotopy H\": (I \\times I,(0,0)) \\to (R,0) such that p \\circ H\" = H. Moreover, if H is a path homotopy between two paths f,g: (I,0) \\to (S1,(1,0)), then H\" is a path homotopy between the \"lifts\" f\",g\": (I,0) \\to (R,0) of f,g from the PLT.       "
},
{
  "id": "prop-5.49",
  "level": "2",
  ...
  "number": "5.3.1",
  "title": "",
  "body": "  For each integer n, let ωn be the loop in S1 defined by ωn(s) := ( cos(2 \\pi n s), sin(2 \\pi n s) ) for all s \\in I. Then [ωm][ωn] = [ωm+n] in \\pi_1(S1,(1,0)).   "
},
{
  "id": "thm-5.50",
  "level": "2",
  ...
  "body": "Path and Path Homotopy Lifting Theorems (PPHLT) for S1   Let p: R \\to S1 be defined by p(t) := (cos(2\\pi t), sin(2\\pi t)) for all t \\in R.   (PLT) Given a path f: (I,0) \\to (S1,(1,0)), there is a unique path f\": (I,0) \\to (R,0) such that p \\circ f\" = f.    (PHLT) Given a path homotopy H: (I \\times I,(0,0)) \\to (S1,(1,0)) there is a unique path homotopy H\": (I \\times I,(0,0)) \\to (R,0) such that p \\circ H\" = H. Moreover, if H is a path homotopy between two paths f,g: (I,0) \\to (S1,(1,0)), then H\" is a path homotopy between the \"lifts\" f\",g\": (I,0) \\to (R,0) of f,g from the PLT.      "
},
{
  "id": "sec-present",
  "level": "1",
...
},
{
  ...
  "number": "5.5.9",
  "title": "",
  "body": "  Let S1 and S2 be two surfaces. For 1 \\leq i \\leq 2, let Ci \\sse Si be a closed set that, as a subspace, has a homeomorphism hi: Ci \\to D2. Let Ui := hi-1(B((0,0),1)) and let Si\\setminus Ui have the subspace topology from Si. Let X := (S1\\setminus U1) ∐ (S2\\setminus U2) have the disjoint union topology, and let \\sim be the smallest equivalence relation on X for which h1-1(p) \\sim h2-1(p) for all p \\in S1. The quotient space X\/\\sim is the connected sum of S1 and S2, and is denoted S1 # S2.   "
},
{
  "id": "thm-5.144",
  "level": "2",
...
},
{
  ...
  "number": "5.5.11",
  "title": "",
  "body": "  If S1 is a surface, then S1 # S2 \\cong S1.   "
},
{
  "id": "example-34",
  "level": "2",
...
},
{
  ...
  "number": "6.1.12",
  "title": "",
  "body": "  Let pi:X̃i \\to Xi be covering spaces for i \\in {1,2}. Then q := (p1 \\circ proj1,p2 \\circ proj2) :X̃1 \\times X̃2 \\to X1 \\times X2 [that is, q(s1,s2) := (p1(s1),p2(s2)) for all (s1,s2) \\in X̃1 \\times X̃2] is also a covering space.   "
},
{
  "id": "cor-6.25",
  "level": "2",
